...
public class DetallecompraMapper implements RowMapper<DetalleCompra> {
	...
	public DetalleCompra mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		detallecompra.setCod_pro(rs.getInt("cod_pro"));
		detallecompra.setPre_detcom(rs.getFloat("pre_detcom"));
		detallecompra.setCan_detcom(rs.getInt("can_detcom"));
		detallecompra.setDes_detcom(rs.getFloat("des_detcom"));
		detallecompra.setSubtotDetcom(rs.getFloat("subtot_detcom"));
		detallecompra.setTotDetcom(rs.getFloat("tot_detcom"));
