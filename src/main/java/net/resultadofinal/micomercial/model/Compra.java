...
public class Compra extends TableRow {
	...
	private String fec_com,obs_com;
	private Float tot_com,des_com,subtotCom;
	...
	public Float getSubtotCom() {
		return subtotCom;
	}
	public void setSubtotCom(Float subtotCom) {
	...
	public Float getDes_com() {
		return des_com;
	}
	public void setDes_com(Float des_com) {
